...
<div class="container">
	...
	<form method="POST" action="index.php?page=store_project" class="card form project-form">
		...
		<?php if (empty($members)): ?>
			<p class="error">
				No workspace members found. Import Member 1's users, workspaces, and workspace_members data first.
			</p>
		<?php else: ?>
